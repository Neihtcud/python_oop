...
class LoyalCustomer(Customer):
    def __init__(self, ma_khach_hang, ten_khach_hang, so_dien_thoai, email, diem_tich_luy=0, tong_gia_tri_mua_hang=0):
    ...
    def __str__(self):
        return f"{super().__str__()} | Điểm tích lũy: {self.diem_tich_luy} | Tổng giá trị: {self.tong_gia_tri_mua_hang:,.0f}"
